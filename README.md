...
This project is dedicated to fine-tuning, evaluating, and running inference on non-standard speech datasets for English and Swahili .The primary goal is to develop a fine-tuned model that better understands non-standard speech for English and Swahili, achieving a lower Character Error Rate (CER) and Word Error Rate (WER).
...
| **Documentation** | [![Markdown](https://img.shields.io/badge/Markdown-F37626?style=for-the-badge&logo=markdown&logoColor=white)](https://www.markdownguide.org/) [![TSV](https://img.shields.io/badge/TSV-1572B6?style=for-the-badge&logo=tabler&logoColor=white)](https://en.wikipedia.org/wiki/Tab-separated_values) [![PDF](https://img.shields.io/badge/PDF-FF0000?style=for-the-badge&logo=adobeacrobatreader&logoColor=white)](https://www.adobe.com/acrobat/about-adobe-pdf.html) |
---
...
- **References** :These are the papers that I've used as reference in my research paper related to this GitHub Repository.
